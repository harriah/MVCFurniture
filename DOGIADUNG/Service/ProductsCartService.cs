...
{
    public interface IProductsCartService
    {           
    ...
    public class ProductsCartService : IProductsCartService
    {
        private readonly IProductsImageRepository _productsImageRepository;
        private IUnitOfWork _unitOfWork;
        public ProductsCartService(IProductsImageRepository productsImageRepository,
